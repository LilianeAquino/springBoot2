...
public class TodoService {
	...
	public Flux<Todo> findBySummaryContainingIgnoreCase(String summary) {
		return todoRepository.findBySummaryContainingIgnoreCase(summary);
	}
	
	public Flux<Todo>findBySummaryContainingAndDescriptionContainingAllIgnoreCaseAndDoneIsTrue(String summary,
			String description) {
		return todoRepository.findBySummaryContainingAndDescriptionContainingAllIgnoreCaseAndDoneIsTrue(summary, description);
	}
